...
**📌 Case 4: Khử lối hành văn cường điệu ("Văn AI") và chuyển dịch cấu trúc**
Khi được yêu cầu viết chuyên sâu, AI thường mắc lỗi sử dụng từ ngữ cường điệu để tạo cảm giác "nguy hiểm", làm mất đi tính khách quan (objectivity) của văn bản học thuật. BẮT BUỘC áp dụng các nguyên tắc sau:
*   **Bảng Blacklist Từ vựng (CẤM DÙNG):**
    *   **Lỗi Tuyệt đối hóa:** *Đồng thuận tuyệt đối, bất khả xâm phạm, sống còn, sinh tử, khốc liệt* -> Đổi thành: Sự đồng thuận, yếu tố cơ sở, tiêu chuẩn thiết yếu.
    *   **Lỗi Ẩn dụ kịch tính:** *Huyết mạch, thế độc tôn, đao to búa lớn* -> Đổi thành: Yếu tố kỹ thuật duy trì tính liền mạch, đóng vai trò quyết định.
    *   **Lỗi Cảm xúc hóa/Phóng đại:** *Sự hào nhoáng, chối bỏ, khuất lấp, vô vàn, ngốn tài nguyên* -> Đổi thành: Tập trung đơn thuần vào cấu hình, không được khuyến nghị, dung lượng lớn.
    *   **Lỗi Ép buộc:** *Không thể thỏa hiệp* -> Đổi thành: Ranh giới tối thiểu, tiêu chuẩn cơ sở.
*   **Chuyển dịch cấu trúc câu (Sentence Structure Shift):**
    *   **Tránh kết luận cảm quan (Khen/Chê):** Thay vì *"Màn hình gương bị đánh giá thấp do gây chói lóa"*, hãy mô tả hiện tượng: *"Màn hình gương không được khuyến nghị do hiện tượng phản chiếu ánh sáng gây ảnh hưởng thị giác"*.
    *   **Chuyển tính từ thành biến số/cơ chế:** Thay vì *"Giá cả vô cùng khắt khe và là bộ lọc cứng"*, hãy dùng cấu trúc: *"Giá cả hoạt động như biến số định khung cho các quyết định đánh đổi phần cứng tiếp theo"*.

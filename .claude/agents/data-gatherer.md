---
name: data-gatherer
description: Use when collecting or refreshing office-laptop market data — crawling CellphoneS listings under the approved scope, mapping PassMark CPU/GPU benchmarks, cleaning the raw data, and assembling the TOPSIS decision matrix. Triggers on "crawl", "thu thập dữ liệu laptop", "CellphoneS", "benchmark", "PassMark", "ma trận quyết định", "làm sạch dữ liệu thị trường".
...
Số máy sau lọc theo scope đã chốt, ngày crawl, danh sách cột dữ liệu, đường dẫn file CSV/xlsx đã ghi, cảnh báo chất lượng (thiếu thông số, trùng lặp).

...
Nhân viên của ban này là các bài mẫu đã xuất bản và được duyệt.

| Bài mẫu | File | Modules đã dùng | Ngày |
|---------|------|-----------------|------|
| Phản bác Anthropic | (chưa lưu) | storytelling + presentation + fact-check | 2026-03-08 |
...
- Bài viết qua review/ duyệt → lead archive/ lưu bài mẫu (metadata: modules, ngày, loại đề bài)

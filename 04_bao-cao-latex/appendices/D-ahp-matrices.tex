...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}lccccccc@{}}
    ...
    \bottomrule
  \end{tabular}
  \floatnote{\emph{Note:} entries above the diagonal are the 21 elicited judgements on the Saaty scale; entries below the diagonal follow from reciprocity. \emph{Source:} authors' own expert elicitation.}
\end{table}
...
$\mathbf{w} = (0.3491,\ 0.2769,\ 0.1201,\ 0.1592,\ 0.0430,\ 0.0258,\ 0.0258)$, matching the
values reported in \Cref{tab:ahp-weights} of \Cref{sec:weights}.
